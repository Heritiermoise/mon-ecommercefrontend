...
interface SouventAchetesEnsembleProps {
  produitId: number;
}

export default function SouventAchetesEnsemble({ produitId }: SouventAchetesEnsembleProps) {
  ...
  const fetchProduits = async () => {
    try {
      const response: any = await searchAPI.getSouventAchetesEnsemble(produitId);
      if (response.success) {
