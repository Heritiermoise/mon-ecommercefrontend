...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { icon: InstagramIcon, href: 'https://instagram.com', label: 'Instagram', color: 'hover:text-pink-500' },
    { icon: TwitterIcon, href: 'https://twitter.com', label: 'Twitter', color: 'hover:text-sky-500' },
    { icon: LinkedinIcon, href: 'https://linkedin.com', label: 'LinkedIn', color: 'hover:text-blue-700' },
    { icon: WhatsAppIcon, href: 'https://wa.me/33123456789', label: 'WhatsApp', color: 'hover:text-green-500' },
    { icon: YoutubeIcon, href: 'https://youtube.com', label: 'YouTube', color: 'hover:text-red-600' },
    { icon: TiktokIcon, href: 'https://tiktok.com', label: 'TikTok', color: 'hover:text-white' },
  ];
    ...
    <footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-slate-300 mt-auto">
      ...
      <div className="container mx-auto px-4 py-12 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <h4 className="text-white font-bold text-lg mb-4">À propos</h4>
            <p className="text-sm text-slate-400 mb-4 leading-relaxed">
              ShopPro est votre destination premium pour des produits de qualité.
            </p>
          ...
          >
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/produits" className="hover:text-primary transition-colors">Boutique</Link></li>
          ...
          >
            <h4 className="text-white font-bold text-lg mb-4">Service client</h4>
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/retours" className="hover:text-primary transition-colors">Retours</Link></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>123 Avenue du Commerce, Paris</span>
              </li>
              ...
              <li className="flex items-center gap-2">
                ...
                <span>contact@shoppro.com</span>
              </li>
              <li className="flex items-center gap-2">
                <WhatsAppIcon className="w-4 h-4 text-green-500 flex-shrink-0" />
                <a href="https://wa.me/33123456789" className="hover:text-green-500 transition-colors">
                  WhatsApp
                </a>
              </li>
            </ul>
        ...
        <div className="container mx-auto px-4 py-8 md:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            >
              ...
              <div>
                <p className="font-semibold text-white text-sm">Livraison rapide</p>
                <p className="text-xs text-slate-400">24-48h</p>
              </div>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, scale: 0.9 }}
            ...
            >
              ...
              <div>
                <p className="font-semibold text-white text-sm">Paiement sécurisé</p>
                <p className="text-xs text-slate-400">100% protégé</p>
              </div>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, scale: 0.9 }}
            ...
            >
              ...
              <div>
                <p className="font-semibold text-white text-sm">Paiement flexible</p>
                <p className="text-xs text-slate-400">M-Pesa, Orange, CB</p>
              </div>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, scale: 0.9 }}
            ...
            >
              ...
              <div>
                <p className="font-semibold text-white text-sm">Support 24/7</p>
                <p className="text-xs text-slate-400">À votre écoute</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-6 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            <p className="text-slate-400">
              © {currentYear} ShopPro. Tous droits réservés.
            </p>
